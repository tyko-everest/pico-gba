...
void LCD_SetGramScanWay(LCD_SCAN_DIR Scan_dir) {
    ...
    if (LCD_2_8 == id) {
        ...
        //  switch(Scan_dir){
        //  case L2R_U2D:
        //  /* Memory access control: MY = 0, MX = 0, MV = 0, ML = 0 RGB = 0 MH
        //  = 0 NN = 0 NN = 0*/ MemoryAccessReg_Data = 0x00; break;
        // case L2R_D2U:
        // /* Memory access control: MY = 0, MX = 0, MV = 0, ML = 1 RGB = 0 MH =
        // 0 NN = 0 NN = 0*/ MemoryAccessReg_Data = 0x10; break; case R2L_U2D:
        // /* Memory access control: MY = 0, MX = 0, MV = 0, ML = 0 RGB = 0 MH =
        // 1 NN = 0 NN = 0*/ MemoryAccessReg_Data = 0x04; break; case R2L_D2U:
        // /* Memory access control: MY = 0, MX = 0, MV = 0, ML = 1 RGB = 0 MH =
        // 1 NN = 0 NN = 0*/ MemoryAccessReg_Data = 0x14; break; case U2D_L2R:
        // //0X2
        // /* Memory access control: MY = 1, MX = 0, MV = 1, ML = 0 RGB = 0 MH =
        // 0 NN = 0 NN = 0*/ MemoryAccessReg_Data = 0xA0; break; case U2D_R2L:
        // //0X6
        // /* Memory access control: MY = 1, MX = 0, MV = 1, ML = 0 RGB = 0 MH =
        // 1 NN = 0 NN = 0*/ MemoryAccessReg_Data = 0xA4; break; case D2U_L2R:
        // //0XA
        // /* Memory access control: MY = 1, MX = 0, MV = 1, ML = 1 RGB = 0 MH =
        // 0 NN = 0 NN = 0*/ MemoryAccessReg_Data = 0xB0; break; case D2U_R2L:
        // //0XE
        // /* Memory access control: MY = 1, MX = 0, MV = 1, ML = 1 RGB = 0 MH =
        // 1 NN = 0 NN = 0*/ MemoryAccessReg_Data = 0xB4; break;
        // }
        sLCD_DIS.LCD_Scan_Dir = Scan_dir;
        // Get GRAM and LCD width and height
        // 240*320,vertical default
        //  if(Scan_dir == L2R_U2D || Scan_dir == L2R_D2U || Scan_dir == R2L_U2D
        //  || Scan_dir == R2L_D2U) { sLCD_DIS.LCD_Dis_Column	= LCD_2_8_WIDTH
        ...
        case R2L_D2U:
            ...
            break;
        case U2D_L2R: // 0X2
            /* Memory access control: MY = 0, MX = 0, MV = 1, ML = 0 	X-Y
             * Exchange*/
            /* Display Function control: NN = 0, GS = 0, SS = 1, SM = 0	*/
...
void LCD_Init(LCD_SCAN_DIR LCD_ScanDir, uint16_t LCD_BLval) {
    ...
    LCD_SetGramScanWay(
        LCD_ScanDir); // Set the display scan and color transfer modes
    Driver_Delay_ms(200);
}
