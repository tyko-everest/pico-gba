...
note:
    This function is suitable for bitmap, because a 16-bit data accounted for 16
points
******************************************************************************/
...
parameter:
    ...
    Height : Bitmap Height
note:
    This function is suitable for bitmap, because a 4-bit data accounted for 1
points Please use the Image2lcd generated array
******************************************************************************/
...
sFONT *GUI_GetFontSize(POINT Dx, POINT Dy) {
    ...
    if (Dx > Font24.Width && Dy > Font24.Height) {
        ...
        // DEBUG("Please change the display area size, or add a larger font to
        // modify\r\n");
    }
    return Font;
}
...
void GUI_Show(void) {
    ...
    if (LCD_2_8 == id) {
        ...
        GUI_DrawCircle(sLCD_DIS.LCD_Dis_Column - 50, 220, 30, CYAN, DRAW_FULL,
                       DOT_PIXEL_DFT);

        // DEBUG("Display String\r\n");
        GUI_DisString_EN(10, 120, "WaveShare Electronic", &Font16,
                         LCD_BACKGROUND, BLUE);
        ...
        GUI_Clear(WHITE);
        if (sLCD_DIS.LCD_Dis_Column >
            sLCD_DIS.LCD_Dis_Page) { // Horizontal screen display

            // DEBUG("Draw Line\r\n");
            GUI_DrawLine(0, 10, LCD_3_5_WIDTH, 10, RED, LINE_SOLID,
                         DOT_PIXEL_2X2);
            GUI_DrawLine(0, 20, LCD_3_5_WIDTH, 20, RED, LINE_DOTTED,
                         DOT_PIXEL_DFT);
            GUI_DrawLine(0, 300, LCD_3_5_WIDTH, 300, RED, LINE_DOTTED,
                         DOT_PIXEL_DFT);
            GUI_DrawLine(0, 310, LCD_3_5_WIDTH, 310, RED, LINE_SOLID,
                         DOT_PIXEL_2X2);
